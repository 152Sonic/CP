...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{g}\mathbin{.!}\Varid{id}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},\Varid{x})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}{}\<[8]%
\>[8]{}\alt{\Varid{t\char95 1}}{\Varid{t\char95 2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t\char95 1}\;\Varid{x}\mathrel{=}[\mskip1.5mu (\text{\tt \char34 \char34},\Varid{x})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t\char95 2}\;(\Varid{o},\Varid{l})\mathrel{=}\map \;(\lambda (\Varid{x},\Varid{y})\to ((\Varid{o}\plus \Varid{x}),\Varid{y}))\;(\Varid{concat}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd}\;{}\<[9]%
\>[9]{}\Varid{p}\mathrel{=}(\Varid{procura}\;\Varid{p})\comp \Varid{dic\char95 exp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{procura}\;\Varid{p}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\Varid{procura}\;\Varid{p}\;((\Varid{a},\Varid{o})\mathbin{:}\Varid{t})\mid \Varid{p}\equiv \Varid{a}{}\<[31]%
\>[31]{}\mathrel{=}\Conid{Just}\;\Varid{o}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{procura}\;\Varid{p}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{m}\mathrel{=}\Varid{dic\char95 imp}\comp (\Varid{inserir\char95 pal}\;\Varid{p}\;\Varid{m})\comp \Varid{dic\char95 exp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inserir\char95 pal}\;\Varid{a}\;\Varid{o}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{o}\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inserir\char95 pal}\;\Varid{a}\;\Varid{o}\;((\Varid{p},\Varid{s1})\mathbin{:}\Varid{t})\mid \Varid{a}\equiv \Varid{p}\mathrel{=}(\Varid{p},(\Varid{inserir2}\;\Varid{o}\;\Varid{s1}))\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{30}{}\<[30]%
\>[30]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{p},\Varid{s1})\mathbin{:}(\Varid{inserir\char95 pal}\;\Varid{a}\;\Varid{o}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inserir2}\;\Varid{s1}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{s1}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inserir2}\;\Varid{s1}\;(\Varid{h2}\mathbin{:}\Varid{t2})\mid \Varid{s1}\equiv \Varid{h2}\mathrel{=}(\Varid{h2}\mathbin{:}\Varid{t2}){}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{h2}\mathbin{:}(\Varid{inserir2}\;\Varid{s1}\;\Varid{t2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{dir\char95 aux}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dir\char95 aux}\;(\Varid{a},(\Varid{e},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{dir\char95 aux}\;(\Varid{a},(\anonymous ,\Varid{d}))\mathrel{=}\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{esq\char95 aux}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{esq\char95 aux}\;(\Varid{a},(\Conid{Nothing},\Varid{d}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{esq\char95 aux}\;(\Varid{a},(\Varid{e},\anonymous ))\mathrel{=}\Varid{e}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=4cm{
    \ensuremath{\fun{BTree} }
            \ar[d]^-{\ensuremath{\Varid{insOrd'}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \times\fun{BTree} ))}
            \ar[l]_-{\ensuremath{\Varid{inBTree}}}
            \ar[d]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{insOrd'}\times\Varid{insOrd'}}}
\\
     \ensuremath{\fun{BTree} \times\fun{BTree} }
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \times\fun{BTree} )\mathbin{\uparrow}\mathrm{2}}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{(\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})),\Conid{Empty})}}{{}\<[60]%
\>[60]{}\Varid{insOrd\char95 a}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{insOrd\char95 a}\;(\Varid{a},((e_2 ,e_1 ),(\Varid{d2},\Varid{d1})))\mathrel{=}\mathbf{if}\;(\Varid{x}\mathbin{>}\Varid{a})\;\mathbf{then}\;(\Conid{Node}\;(\Varid{a},(e_1 ,\Varid{d2})),\Conid{Node}\;(\Varid{a},(e_1 ,\Varid{d1})))\;\mathbf{else}\;(\Conid{Node}\;(\Varid{a},(e_2 ,\Varid{d1})),\Conid{Node}\;(\Varid{a},(e_1 ,\Varid{d1}))){}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=4cm{
    \ensuremath{\fun{BTree} }
            \ar[d]^-{\ensuremath{\Varid{isOrd}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \times\fun{BTree} ))}
            \ar[l]_-{\ensuremath{\Varid{inBTree}}}
            \ar[d]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{isOrd'}\times\Varid{isOrd'}}}
\\
     \ensuremath{\Conid{Bool}\times\fun{BTree} }
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\Conid{Bool}\times\fun{BTree} )\mathbin{\uparrow}\mathrm{2}}
            \ar[l]_-{\ensuremath{\Varid{g}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{(\Conid{True},\Conid{Empty})}}{{}\<[42]%
\>[42]{}\Varid{isOrd\char95 a}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{isOrd\char95 a}\;(\Varid{a},((\Varid{b1},\Conid{Empty}),(\Varid{b2},\Conid{Empty})))\mathrel{=}\mathbf{if}\;(\Varid{b1}\mathrel{\wedge}\Varid{b2})\;\mathbf{then}\;(\Conid{True},\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty})))\;{}\<[96]%
\>[96]{}\mathbf{else}\;(\Conid{False},\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{isOrd\char95 a}\;(\Varid{a},((\Varid{b1},\Conid{Empty}),(\Varid{b2},\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2})))))\mathrel{=}\mathbf{if}\;(\Varid{a}\leq \Varid{d}\mathrel{\wedge}\Varid{b1}\mathrel{\wedge}\Varid{b2})\;\mathbf{then}\;(\Conid{True},\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2})))))\;\mathbf{else}\;(\Conid{False},\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2}))))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{isOrd\char95 a}\;(\Varid{a},((\Varid{b1},\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1}))),(\Varid{b2},\Conid{Empty})))\mathrel{=}\mathbf{if}\;(\Varid{a}\geq \Varid{e}\mathrel{\wedge}\Varid{b1}\mathrel{\wedge}\Varid{b2})\;\mathbf{then}\;(\Conid{True},\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1})),\Conid{Empty})))\;\mathbf{else}\;(\Conid{False},\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1})),\Conid{Empty}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{isOrd\char95 a}\;(\Varid{a},((\Varid{b1},\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1}))),(\Varid{b2},\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2})))))\mid \Varid{a}\geq \Varid{e}\mathrel{\wedge}\Varid{a}\leq \Varid{d}\mathrel{\wedge}\Varid{b1}\mathrel{\wedge}\Varid{b2}\mathrel{=}(\Conid{True},\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1})),\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2}))))){}\<[E]%
\\
\>[9]{}\hsindent{61}{}\<[70]%
\>[70]{}\mid \Varid{otherwise}\mathrel{=}(\Conid{False},\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{r1})),\Conid{Node}\;(\Varid{d},(\Varid{l2},\Varid{r2}))))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{l},\Varid{r})),\Varid{d})))\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{l},\Conid{Node}\;(\Varid{a},(\Varid{r},\Varid{d})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{e},\Conid{Empty})))\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{e},\Conid{Node}\;(\Varid{d},(\Varid{l},\Varid{r})))))\mathrel{=}\Conid{Node}\;(\Varid{d},(\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{l})),\Varid{r})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection{splay}
...
\xymatrix@C=4cm{
    \ensuremath{\fun{BTree} }
            \ar[d]^-{\ensuremath{\Varid{splay}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \times\fun{BTree} ))}
            \ar[l]_-{\ensuremath{\Varid{inBTree}}}
            \ar[d]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{splay}\times\Varid{splay}}}
\\
     \ensuremath{\fun{BTree} \mathbin{\uparrow}\Conid{Bool}\mathbin{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \mathbin{\uparrow}\Conid{Bool}\mathbin{*})\mathbin{\uparrow}\mathrm{2}}
            \ar[l]_-{\ensuremath{\Varid{g}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{x}\to \underline{\Conid{Empty}}}{\Varid{curry}\;(\Varid{aux\char95 spl})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 spl}\;((\Varid{a},(\Varid{e},\Varid{d})),[\mskip1.5mu \mskip1.5mu])\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e}\;[\mskip1.5mu \mskip1.5mu],\Varid{d}\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 spl}\;((\Varid{a},(\Varid{e},\Varid{d})),(\Varid{h}\mathbin{:}\Varid{t}))\mid \Varid{h}\equiv \Conid{True}{}\<[49]%
\>[49]{}\mathrel{=}\Varid{e}\;\Varid{t}{}\<[E]%
\\
\>[9]{}\hsindent{27}{}\<[36]%
\>[36]{}\mid \Varid{otherwise}\mathrel{=}\Varid{d}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{a},(\Varid{t1},\Varid{t2}))){}\<[29]%
\>[29]{}\mathrel{=}i_2\;(\Varid{a},(\Varid{t1},\Varid{t2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataBdt}\;\Varid{a}\mathrel{=}\Varid{a}\comp (\Varid{recBdt}\;(\Varid{cataBdt}\;\Varid{a}))\comp \Varid{outBdt}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{String}\mathbin{+}(\Conid{String}\times(\Conid{Bdt}\times\Conid{Bdt}))}
            \ar[l]_-{\ensuremath{\Varid{inBdt}}}
\\
     \ensuremath{\Conid{Bdt'}}
            \ar[u]^-{\ensuremath{\Varid{ana}\;\Varid{f}}}
            \ar[r]_-{\ensuremath{\Varid{f}}}
&
     \ensuremath{\Conid{String}\mathbin{+}\Conid{String}\times(\Conid{Bdt'}\times\Conid{Bdt'})}
           \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{ana}\;(\Varid{f}\times\Varid{f})}}
}
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}}
            \ar[d]^-{\ensuremath{\Varid{navLTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\mathsf{LTree}\times\mathsf{LTree})}
            \ar[l]_-{\ensuremath{\Varid{inLTree}}}
            \ar[d]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{navLTree}\times\Varid{navLTree}}}
\\
     \ensuremath{\mathsf{LTree}\mathbin{\uparrow}\Conid{Bool}\mathbin{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\mathsf{LTree}\mathbin{\uparrow}\Conid{Bool}\mathbin{*})\mathbin{\uparrow}\mathrm{2}}
            \ar[l]_-{\ensuremath{\Varid{g}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{\Conid{Leaf}}}{\Varid{curry}\;\Varid{aux\char95 Nav}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 Nav}\;((\Varid{l},\Varid{v}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}\Conid{Fork}\;(\Varid{l}\;[\mskip1.5mu \mskip1.5mu],\Varid{v}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 Nav}\;((\Varid{l},\Varid{v}),(\Varid{h}\mathbin{:}\Varid{t}))\mid \Varid{h}\equiv \Conid{True}{}\<[45]%
\>[45]{}\mathrel{=}\Varid{l}\;\Varid{t}{}\<[E]%
\\
\>[9]{}\hsindent{23}{}\<[32]%
\>[32]{}\mid \Varid{otherwise}\mathrel{=}\Varid{v}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}}
            \ar[d]^-{\ensuremath{\Varid{bnavLTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\mathsf{LTree}\times\mathsf{LTree})}
            \ar[l]_-{\ensuremath{\Varid{inLTree}}}
            \ar[d]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{bnavLTree}\times\Varid{bnavLTree}}}
\\
     \ensuremath{\mathsf{LTree}\mathbin{\uparrow}\fun{BTree} \;(\Conid{Bool})}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\mathsf{LTree}\mathbin{\uparrow}\fun{BTree} \;(\Conid{Bool}))\mathbin{\uparrow}\mathrm{2}}
            \ar[l]_-{\ensuremath{\Varid{g}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{\Conid{Leaf}}}{\Varid{curry}\;\Varid{aux\char95 bNav}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 bNav}\;((\Varid{l},\Varid{r}),\Conid{Empty})\mathrel{=}\Conid{Fork}\;(\Varid{l}\;\Conid{Empty},\Varid{r}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{aux\char95 bNav}\;((\Varid{l},\Varid{r}),(\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{d}))))\mid \Varid{a}\equiv \Conid{True}\mathrel{=}\Varid{l}\;\Varid{e}{}\<[E]%
\\
\>[9]{}\hsindent{33}{}\<[42]%
\>[42]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
